...
function useStateWithHistory(initialState, capacity, initialHistory) {
    ...
    var _a = hooks_1.useState(initialState), state = _a[0], innerSetState = _a[1];
    var history = hooks_1.useRef((initialHistory !== null && initialHistory !== void 0 ? initialHistory : []));
    var historyPosition = hooks_1.useRef(0);
    ...
    var historyState = hooks_1.useMemo(function () { return ({
