...
var useSpring = function (targetValue, tension, friction) {
    ...
    var _a = hooks_1.useState(null), spring = _a[0], setSpring = _a[1];
    var _b = hooks_1.useState(targetValue), value = _b[0], setValue = _b[1];
    ...
    var listener = hooks_1.useMemo(function () { return ({
