...
var useDropArea = function (options) {
    ...
    var _a = hooks_1.useState(false), over = _a[0], setOver = _a[1];
    var process = hooks_1.useMemo(function () { return createProcess(options, isMounted()); }, [onFiles, onText, onUri]);
    var bond = hooks_1.useMemo(function () { return createBond(process, setOver); }, [process, setOver]);
