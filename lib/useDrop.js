...
var useDrop = function (options, args) {
    ...
    var _a = hooks_1.useState(false), over = _a[0], setOverRaw = _a[1];
    var setOver = hooks_1.useCallback(setOverRaw, []);
    var process = hooks_1.useMemo(function () { return createProcess(options); }, [onFiles, onText, onUri]);
