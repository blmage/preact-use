...
function useStateList(stateSet, initialState) {
    ...
    var index = hooks_1.useRef(initialIndex);
    ...
    var actions = hooks_1.useMemo(function () { return ({
    ...
    return tslib_1.__assign({ state: stateSet[index.current], prevState: stateSet[prevIndex], nextState: stateSet[nextIndex], currentIndex: index.current, prevIndex: prevIndex,
