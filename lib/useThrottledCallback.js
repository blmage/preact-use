...
var useThrottledCallback = function (fn, options) {
    ...
    var pendingCall = hooks_1.useRef(null);
    var baseCallback = hooks_1.useCallback(function () {
        var args = [];
    ...
    return hooks_1.useCallback(function () {
        ...
        return baseCallback.apply(void 0, tslib_1.__spreadArrays(baseArgs, additionalArgs));
