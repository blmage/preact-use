...
var useMap = function (initialMap) {
    ...
    var _a = hooks_1.useState(initialMap), map = _a[0], set = _a[1];
    var stableActions = hooks_1.useMemo(function () { return ({
    ...
    var utils = tslib_1.__assign({ get: hooks_1.useCallback(function (key) { return map[key]; }, [map]) }, stableActions);
    return [map, utils];
};
