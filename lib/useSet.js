...
var useSet = function (initialSet) {
    ...
    var _a = hooks_1.useState(initialSet), set = _a[0], setSet = _a[1];
    var stableActions = hooks_1.useMemo(function () {
    ...
    var utils = tslib_1.__assign({ has: hooks_1.useCallback(function (item) { return set.has(item); }, [set]) }, stableActions);
    return [set, utils];
};
